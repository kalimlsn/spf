...
select
    ...
    {{ json_extract_scalar('prerequisite_subtotal_range', ['greater_than_or_equal_to'], ['greater_than_or_equal_to']) }} as greater_than_or_equal_to,
    _airbyte_ab_id,
    _airbyte_emitted_at,
...
where 1 = 1
and prerequisite_subtotal_range is not null
