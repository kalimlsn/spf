...
select
    ...
    {{ json_extract_scalar(unnested_column_value('variants'), ['shop_url'], ['shop_url']) }} as shop_url,
    {{ json_extract_scalar(unnested_column_value('variants'), ['created_at'], ['created_at']) }} as created_at,
    {{ json_extract_scalar(unnested_column_value('variants'), ['product_id'], ['product_id']) }} as product_id,
